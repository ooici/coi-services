...
from interface.services.dm.iingestion_management_service_a import BaseIngestionManagementServiceA
from interface.objects import IngestionConfigurationA, IngestionQueue, StreamQuery


class IngestionManagementServiceA(BaseIngestionManagementServiceA):
