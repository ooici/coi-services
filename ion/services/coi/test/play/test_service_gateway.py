...
class TestServiceGateway(IonIntegrationTestCase):
    ...
    def test_list_resource_types(self):
        ...
        self.assertIn('ExternalDatasetAgent', gateway_resp)
        self.assertIn('ExternalDatasetAgentInstance', gateway_resp)
        self.assertIn('ExternalDataProvider', gateway_resp)
        self.assertIn('ExternalDatasetModel', gateway_resp)
        ...
        self.assertIn('Observatory', gateway_resp)
        ...
        self.assertIn('ActorCredentials', gateway_resp)
