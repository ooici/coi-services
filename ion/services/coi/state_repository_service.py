...
class StateRepositoryService(BaseStateRepositoryService):
    """
    The Service State Repository is based on the ION Common Object Model. Its purpose is to provide
    persistent storage for transient process state at the end of the processing of messages.
    """
