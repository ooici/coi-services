...
class TestActivateInstrumentIntegration(IonIntegrationTestCase):
    ...
    def test_activateInstrumentSample(self):
        ...
        log.debug( "test_activateInstrumentSample: extended_product computed user_notification_requests %s", [i.__dict__ for i in extended_product.computed.user_notification_requests])
        ...
        log.debug( "test_activateInstrumentSample: extended_instrument computed user_notification_requests %s", [i.__dict__ for i in extended_instrument.computed.user_notification_requests])
