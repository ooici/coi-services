...
"""
@file  ion.services.sa.data_process_management.test.
          test_data_process_management_service
@author   Alon Yaari
@test ion.services.sa.data_process_management.data_process_management_service
          Unit test suite to cover all service code
"""

from nose.plugins.attrib import attr
from pyon.util.unit_test import PyonTestCase
from ion.services.sa.data_process_management.data_process_management_service \
    import DataProcessManagementService

mockDataProcessObj = 'ion.services.sa.data_process_management.' + \
