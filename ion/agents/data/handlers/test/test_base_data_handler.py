...
from ion.agents.instrument.exceptions import InstrumentParameterException,\
    InstrumentDataException, InstrumentCommandException,\
    NotImplementedException, InstrumentException
...
from ion.agents.data.handlers.base_data_handler import BaseDataHandler,\
    ConfigurationError, DummyDataHandler, FibonacciDataHandler
from ion.services.dm.utility.granule.record_dictionary import\
...
class TestBaseDataHandlerUnit(PyonTestCase):
    ...
    def test_get_patchable_config_keys(self):
        ...
        self.assertEqual(ret, {'PATCHABLE_CONFIG_KEYS': ['stream_id',
                                                         'constraints',
                                                         'stream_route']})
    ...
    def test_set_polling(self):
        ...
        self.assertEqual(self._bdh.get(['POLLING_INTERVAL']),
    ...
    def test__update_new_data_check_attachment_raise_notfound(self, rr_cli_cls):
        ...
        with self.assertRaises(InstrumentException):
            self._bdh._update_new_data_check_attachment(res_id='not_found',
    ...
    def test_execute_acquire_sample_with_stream_id_new_not_already_acquiring_res_not_found(self, mock, StreamPublisher_mock):
        ...
        self.assertRaises(InstrumentException,
            self._bdh.execute_acquire_sample,
            {'stream_id': 'test_stream_id',
             'stream_route': stream_route})
        self._bdh._semaphore.acquire.assert_called_once_with(blocking=False)
        self._bdh._find_new_data_check_attachment.assert_called_once()
