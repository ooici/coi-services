...
def process_index():
    try:
        ...
        fragments = [
            ...
            "<ul>",
            "<li>Org: <a href='/list/Org'>Org</a>, <a href='/list/UserRole'>Org Role</a></li>",
            "<li>Users: <a href='/list/UserInfo'>User</a>, <a href='/list/ActorIdentity'>Actor Identity</a>, <a href='/list/UserCredentials'>User Credentials</a></li>",
            ...
            "<li>Devices: <a href='/list/PlatformDevice'>PlatformDevice</a>, <a href='/list/InstrumentDevice'>InstrumentDevice</a></li>",
            "<li>Models: <a href='/list/PlatformModel'>PlatformModel</a>, <a href='/list/InstrumentModel'>InstrumentModel</a></li>",
