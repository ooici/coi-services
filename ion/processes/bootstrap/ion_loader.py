...
class IONLoader(ImmediateProcess):
    ...
    def _load_User(self, row):
        ...
        actor_identity_obj = IonObject("ActorIdentity", {"name": subject, "contact": {"name": name, "email": email}})
        ...
        actor_credentials_obj = IonObject("ActorCredentials", {"name": subject})
        ims.register_actor_credentials(user_id, actor_credentials_obj)
