...
class CTDL1PressureTransform(TransformDataProcess):
    ...
    def recv_packet(self, msg, headers):
        log.info('CTDL1PressureTransform.recv_packet: {0}'.format(msg))
...
class CTDL1PressureTransformAlgorithm(SimpleGranuleTransformFunction):
    ...
    def execute(input=None, context=None, config=None, params=None, state=None):
        ...
        result = CTDL1PressureTransformAlgorithm._build_granule_settings(pres_pdict, 'pressure', pressure, time, latitude, longitude, depth)
    ...
    def _create_parameter():
        ...
        pdict = CTDL1PressureTransformAlgorithm._add_location_time_ctxt(pdict)
    ...
    def _build_granule_settings(param_dictionary=None, field_name='', value=None, time=None, latitude=None, longitude=None, depth=None):
        ...
        return build_granule(data_producer_id='ctd_L1_pressure', param_dictionary=param_dictionary, record_dictionary=root_rdt)