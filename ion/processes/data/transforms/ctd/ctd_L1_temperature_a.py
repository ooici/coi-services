...
#cc.spawn_process('l0_transform', 'ion.processes.data.transforms.ctd.ctd_L1_temperature_a','ctd_L1_temperature', config={'process':{'publish_streams':{'conductivity':c_stream_id, 'temperature':t_stream_id, 'pressure': p_stream_id }, 'subscriber_streams':{'stream_id':stream_id} } })
